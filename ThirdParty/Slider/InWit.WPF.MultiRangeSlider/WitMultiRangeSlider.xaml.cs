...
#pragma warning restore 67
        ...
        private string m_leftValueBinding;
        private string m_rightValueBinding;
        ...
        private WitMultiRangeSliderItem CreateSlider(object item)
        {
            ...
            slider.SetBinding(WitMultiRangeSliderItem.LeftValueProperty, new Binding { Source = item, Path = new PropertyPath(LeftValueBinding), Mode = BindingMode.TwoWay });
            slider.SetBinding(WitMultiRangeSliderItem.RightValueProperty, new Binding { Source = item, Path = new PropertyPath(RightValueBinding), Mode = BindingMode.TwoWay });
        ...
        //    }
        //}
        public string LeftValueBinding
        {
            get { return m_leftValueBinding; }
            set
            {
        ...
        public string RightValueBinding
        {
            get { return m_rightValueBinding; }
            set
            {

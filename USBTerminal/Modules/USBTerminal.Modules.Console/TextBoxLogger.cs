...
{
    public class TextBoxLogger : CustomRichTextBox, ITextBoxLogger
    {
        #region ILogger
        ...
        {
            readOnlyItems.Dispatcher.BeginInvoke(new Action(() => DoLogging(messageTemplate, CustomRun.Debug)));
        }
        ...
        {
            readOnlyItems.Dispatcher.BeginInvoke(new Action(() => DoLogging(messageTemplate, CustomRun.Error)));
        }
        ...
        {
            readOnlyItems.Dispatcher.BeginInvoke(new Action(() => DoLogging(messageTemplate, CustomRun.Info)));
        }
        ...
        private void DoLogging(string message, CustomRun run)
        {
